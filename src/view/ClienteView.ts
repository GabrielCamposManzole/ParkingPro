...
export default class ClienteView {
     ...
     */
    public exibirMenuClientes(): void {
    ...
    private cadastrar(): void {
        ...
        if (isNaN(tipo) || !Object.values(ClientType).includes(tipo)) {
    ...
    private listar(): void {
        ...
        clientes.forEach(cliente => {
            console.log(`- Nome: ${cliente.getNome()}, CPF: ${cliente.getCpf()}, Tipo: ${ClientType[cliente.getTipo()]}`);
        });
    }
    ...
    private atualizar(): void {
        ...
        const novoTipo = parseInt(novoTipoInput) as ClientType;
